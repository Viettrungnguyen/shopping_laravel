...
@endsection
@section('content')
    @include('partials.admin.content-header', ['name' => 'User', 'page' => 'Edit'])
    <form action="{{ route('user.update', ['id' => $user->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label>Title</label>
            <textarea class="form-control" id="mytextarea" rows="3" name="title">{{ $user->title }}</textarea>
            @if ($errors->has('title'))
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <input type="file" class="form-control" name="avatar_url" id="avatar_url" multiple>
                <input type="text" name="avatar_url" value="{{ $user->avatar_url }}" hidden>
        ...
        <div class="mb-3">
            <label>Note</label>
            <textarea class="form-control" id="mytextarea" rows="3" name="note">{{ $user->note }}</textarea>
            @if ($errors->has('note'))
        ...
        <div class="mb-3">
            <label>Skills</label>
            <textarea class="form-control" id="mytextarea" rows="3" name="skills">{{ $user->skills }}</textarea>
